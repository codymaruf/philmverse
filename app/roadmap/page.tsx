...
const roadmapItems = [
  {
    ...
    description: "Never miss a crucial angle — generate comprehensive shot lists through natural conversation with your AI partner.",
  ...
  },
  {
    ...
    description: "Reorganize and polish your story structure through intuitive conversation — no complex interfaces, just creative dialogue.",
    section: "Near Future Magic",
  },
  {
  ...
  },
  {
    ...
    description: "AI that understands rhythm, tension, and emotional beats — your conversational co-pilot for masterful storytelling.",
    section: "Next-Level Creation",
  },
  {
    icon: <List className="w-12 h-12 text-green-400" />,
    title: "Complete Production Magic",
    description: "From initial chat to call sheets, budgets, and schedules — all generated through natural creative conversation.",
